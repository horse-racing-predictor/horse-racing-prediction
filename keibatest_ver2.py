...
for num in range(1,5):
	for day in range(1,9):
		for racenum in range(1,12):
			...
			url = "http://db.netkeiba.com/race/2018"+"06"+str(num).zfill(2)+str(day).zfill(2)+str(racenum).zfill(2)+"/"
			...
			for l in trlist:
				...
				fname = "06"+str(num).zfill(2)+str(day).zfill(2)+str(racenum).zfill(2)+".csv"
